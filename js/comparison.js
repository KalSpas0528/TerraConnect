document.addEventListener("DOMContentLoaded", () => {
    // Elements for the country comparison modal and button
    ...
    // Open the comparison modal when the "Compare Countries" button is clicked
    ...
    async function populateComparisonDropdowns() {
      try {
        ...
        console.log("Dropdowns populated with country names.");
      } catch (error) {
    ...
    // Attach event listener for compare button inside modal
    if (compareBtn) {
